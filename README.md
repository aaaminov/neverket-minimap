...
- режим освещения карты: постоянная яркость или затемнение ночью;
...
Режим записи «Сделанные карты» сохраняет только полученные пиксели предметов-карт. Вариант «Пиксельно» точно сохраняет их ванильный масштаб. Вариант «Всегда детально» дополнительно уточняет территорию карты по чанкам, которые клиент действительно загрузил; восстановить отсутствующие внутри крупного пикселя данные удалённой карты технически невозможно.
