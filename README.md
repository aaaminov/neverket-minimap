...
На полноэкранной карте удерживайте назначенную клавишу отладки, по умолчанию `Ctrl`. Последние 16 обработанных чанков будут закрашены: новый ярче, старые постепенно прозрачнее.
