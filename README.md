...
![Мини-карта с ванильной картой](screenshots/2026-07-14_22.07.01.png)

### Настройки мода

![Настройки мода](screenshots/2026-07-14_22.04.19.png)

### Неразведанная местность

![Мини-карта с полуразведанной местностью вокруг игрока](screenshots/2026-07-14_22.38.48.png)

### Исследованная территория

![Полноэкранная карта с границами исследованной территории](screenshots/2026-07-14_22.40.11.png)

### Полноэкранная карта

![Полноэкранная карта 2](screenshots/2026-07-14_22.03.36.png)
...
На полноэкранной карте удерживайте левую кнопку мыши для перемещения, используйте колесо для масштаба, кнопку слева сверху для смены измерения и кнопку `К игроку` для возврата к текущей позиции. Щёлкните ПКМ по карте, чтобы мгновенно создать или перенести единственную быструю метку в выбранную точку; ПКМ по самой метке удаляет её.
