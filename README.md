...
Опция показывает вокруг игрока упрощённый чёрно-белый контур загруженной поверхности. Вода и суша имеют разные оттенки, а внешний край плавно исчезает. Палитра, смешивание границ и темп обновления одинаковы на Minecraft 1.21.1 и 26.2.
