...
Версия должна быть 25. Важно выполнять команды из каталога репозитория `neverket-minimap`:
...
| Подсветка известных биомов | `ALT` |
| Поставить/убрать быструю метку у игрока | `Ctrl+M` / `ПКМ` |
| Открыть настройки мода | `N` |
