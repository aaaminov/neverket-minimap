...
Быстрая метка и баннеры отображаются на обеих картах. За пределами видимой области они скользят прямо по рамке; быстрая метка показывается всегда, а максимальное число ближайших баннеров на рамке — до 32 — задаётся в разделе `Настройки → Метки`. Там же находится визуальный выбор из пяти исходных ванильных иконок, четырёх аккуратно перекрашенных ванильных вариантов и трёх новых пиксельных символов. Выбранный вариант использует обычное выделение кнопки Minecraft.
