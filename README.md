...
Мини-карта принимает новые данные не чаще одного раза в 250 мс. При включённом вращении её проекция перестраивается с тем же интервалом и шагом 2°; карта, метки, игроки и указатель севера всегда используют один применённый угол и остаются синхронными без пустых углов. Для более дорогой полноэкранной текстуры интервал составляет 350 мс.
