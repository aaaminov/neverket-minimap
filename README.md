...
Названия файлов атласов — безопасные SHA-256-идентификаторы. Внутри хранится исходный адрес/идентификатор мира, метаданные карт, быстрая метка, обнаруженные метки баннеров и цвета карт в Base64. Никакие данные не отправляются сторонним сервисам.
